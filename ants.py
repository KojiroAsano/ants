...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant and place.ant.can_contain(self):
                # print("DEBUG: ", type(place.ant), type(self))
                place.ant.store_ant(self)
            elif place.ant and self.can_contain(place.ant):
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        if self.lower_bound == self.lower_bound:
            while not p.is_hive and n < self.lower_bound:
                p = p.entrance
                n += 1
            if p.bees: return random_bee(p.bees)


        while n < self.lower_bound and not p.is_hive:
            # print("DEBUG:", p)
            print("DEBUG:", p, "upper", self.upper_bound,"lower", self.lower_bound)
            p = p.entrance
            n += 1

        # print("DEBUG: ", n)
        while not p.is_hive and n < self.upper_bound:
            # print("DEBUG:", p)
            if p.bees: return random_bee(p.bees)
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        if self.ant_contained: return False
        # print("DEBUG: ", other)
    ...
    def action(self, gamestate):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        if self.place and self.place.ant and self.can_contain(self.place.ant):
        ...
        # print("DEBUG:", self.place.bees, self.place.ant, self.ant_contained)
        # END Problem 8a
...
class TankAnt(ContainerAnt):
    ...
    def action(self, gamestate):
        ...
        if self.place.bees != None:
            ...
            for bee in bees:
                print("DEBUG: ", bees, len(self.place.bees))
                bee.reduce_health(self.damage)
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        # print("DEBUG: ", insect, insect.is_waterproof )
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if gamestate.is_queen_exit:
            return None
        
        gamestate.is_queen_exit = True
    ...
    def action(self, gamestate):
        ...
        while type(behind_place) != AntHomeBase:

            if behind_place.ant != None:
                the_ant = behind_place.ant
                if the_ant.is_doubled == False:
                    the_ant.double()

                if isinstance(the_ant, ContainerAnt) and \
                    the_ant.ant_contained and\
                    the_ant.ant_contained.is_doubled == False:
